    ...
    return [
      {
        ...
        items: [
          {
            id: 'analytics-opt-in',
            description: 'When enabled, share anonymous usage data to help improve the toolbar.',
          ...
          {
            id: 'enhanced-analytics-opt-in',
            description: 'When enabled, include your account and member information with analytics.',
          ...
          },
          {
            ...
            description: 'When enabled, record your interactions with the toolbar for debugging.',
