...
import lazyLoadToolbar from './utils/lazyLoadToolbar';
import { LaunchDarklyToolbar } from './types/launchDarklyToolbar';
...
function versionToCdn(version = 'latest'): string {
  return `https://static.launchdarkly.com/developer-toolbar/${version}/toolbar.min.js`; // example cdn url. no clue what this will be
}